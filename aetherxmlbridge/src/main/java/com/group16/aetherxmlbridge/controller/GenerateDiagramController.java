...
@RestController
public class GenerateDiagramController
{
    private final ChatClient chatClient;
    private final ObjectMapper objectMapper;

    public GenerateDiagramController(ChatClient.Builder builder, ObjectMapper objectMapper) throws IOException
    {
        String systemPrompt = new ClassPathResource("prompts/project-diagram.txt")
    ...
    @PostMapping(value = "/generate-diagram", produces = MediaType.APPLICATION_XML_VALUE)
    ...
    )
    {
        try
        {
            ...
            headers.add(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + getFileName(dealName) + ".drawio\"");
    ...
    {
        String title = getBoxText("Deal: " + nullSafe(dealName).trim(), "Deal: Generated Diagram");
            ...
            <mxGraphModel dx="1600" dy="900" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1400" pageHeight="1000" math="0" shadow="0">
              <root>
                ...
                <mxCell id="2" value="%s" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#dae8fc;strokeColor=#6c8ebf;fontSize=16;fontStyle=1;" vertex="1" parent="1">
                  <mxGeometry x="420" y="20" width="360" height="70" as="geometry"/>
                </mxCell>
                ...
                <mxCell id="4" value="%s" style="ellipse;whiteSpace=wrap;html=1;fillColor=#d5e8d4;strokeColor=#82b366;fontSize=14;" vertex="1" parent="1">
                  <mxGeometry x="500" y="140" width="200" height="80" as="geometry"/>
                </mxCell>

                <mxCell id="5" value="%s" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#fff2cc;strokeColor=#d6b656;fontSize=14;" vertex="1" parent="1">
                  <mxGeometry x="500" y="280" width="200" height="90" as="geometry"/>
                </mxCell>

                <mxCell id="6" value="%s" style="ellipse;whiteSpace=wrap;html=1;fillColor=#e1d5e7;strokeColor=#9673a6;fontSize=14;" vertex="1" parent="1">
                  <mxGeometry x="500" y="430" width="200" height="90" as="geometry"/>
                </mxCell>

                <mxCell id="7" value="%s" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#f5f5f5;strokeColor=#666666;fontSize=13;" vertex="1" parent="1">
                  <mxGeometry x="80" y="170" width="300" height="120" as="geometry"/>
                </mxCell>
                ...
                <mxCell id="8" value="%s" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#f5f5f5;strokeColor=#666666;fontSize=13;" vertex="1" parent="1">
                  <mxGeometry x="820" y="170" width="300" height="120" as="geometry"/>
                </mxCell>
                ...
                <mxCell id="10" value="%s" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#f5f5f5;strokeColor=#666666;fontSize=13;" vertex="1" parent="1">
                  <mxGeometry x="820" y="350" width="300" height="140" as="geometry"/>
                </mxCell>

                <mxCell id="11" value="" style="endArrow=block;html=1;rounded=0;strokeWidth=2;" edge="1" parent="1" source="2" target="4">
                  <mxGeometry relative="1" as="geometry"/>
                </mxCell>

                <mxCell id="12" value="" style="endArrow=block;html=1;rounded=0;strokeWidth=2;" edge="1" parent="1" source="4" target="5">
                  <mxGeometry relative="1" as="geometry"/>
                </mxCell>
                ...
                <mxCell id="14" value="" style="endArrow=block;html=1;rounded=0;strokeWidth=2;dashed=1;" edge="1" parent="1" source="7" target="5">
                  <mxGeometry relative="1" as="geometry"/>
                </mxCell>

                <mxCell id="15" value="" style="endArrow=block;html=1;rounded=0;strokeWidth=2;dashed=1;" edge="1" parent="1" source="8" target="5">
                  <mxGeometry relative="1" as="geometry"/>
                </mxCell>

                <mxCell id="16" value="" style="endArrow=block;html=1;rounded=0;strokeWidth=2;dashed=1;" edge="1" parent="1" source="9" target="5">
                  <mxGeometry relative="1" as="geometry"/>
                </mxCell>

                <mxCell id="17" value="" style="endArrow=block;html=1;rounded=0;strokeWidth=2;dashed=1;" edge="1" parent="1" source="10" target="5">
                  <mxGeometry relative="1" as="geometry"/>
                </mxCell>

                <mxCell id="18" value="" style="endArrow=block;html=1;rounded=0;strokeWidth=2;dashed=1;" edge="1" parent="1" source="3" target="2">
                  <mxGeometry relative="1" as="geometry"/>
                </mxCell>
